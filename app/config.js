...
var currentCoin = process.env.BTCEXP_COIN || "BTCV";
...
module.exports = {
    ...
    site: {
        ...
        addressTxPageSizeLimit: 100,
        txMaxInput: 15,
        browseBlocksPageSize: 20,
        browseBlocksPageSizeLimit: 100,
        addressPage: {
    ...
    siteTools: [
        ...
        },
        {
            ...
            url: "/mining-pools",
            desc: "Estimated hashrate of mining pools.",
            fontawesome: "fas fa-chart-pie"
        },
        {
            name: "Richest Wallets",
            url: "/richest-wallets",
            desc: "Richest wallets list.",
            fontawesome: "fas fa-money-bill-wave"
        },
        {
            name: "Coin distribution",
            url: "/coin-distribution",
            desc: "Coin distribution.",
            fontawesome: "fas fa-chart-pie"
        }
    ],
